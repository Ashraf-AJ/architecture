...
def test_prefers_current_stock_batches_to_shipments():
    ...
    shipment_batch = Batch("shipment-batch", sku, 100, eta=None)
...
def test_prefers_earlier_batches():
    ...
    earliest = Batch("speedy-batch", sku, 100, eta=None)
    medium = Batch("normal-batch", sku, 100, eta=None)
    latest = Batch("slow-batch", sku, 100, eta=None)
    line = OrderLine("oref", sku, 10)
